...
# データを読み込む
df = pd.read_csv('Energy_Data_20200920_20231027.csv')
...
# 特徴量リスト
features_SSP = ['SS_Price_24h_ago', 'SS_Price_48h_ago', 'SS_Price_1week_ago', 'hourSin', 'hourCos', 'Solar_MW_24h_ago', 'Wind_MW_24h_ago']
...
# 特徴量リスト
features_DA_Price = ['DA_Price_24h_ago', 'DA_Price_48h_ago', 'DA_Price_1week_ago', 'hourSin', 'hourCos', 'Solar_MW_24h_ago', 'Wind_MW_24h_ago']
